<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center bg-gray-100 p-4 rounded-lg shadow-md">
            ...
            <a href="{{ route('contrainte_salles.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex items-center space-x-2">
                                            @if (!$contrainte->validee)
                                                <form action="{{ route('contrainte_salles.valider', $contrainte->id) }}" method="POST" class="inline-block">
                                                    @csrf
                                                    @method('PATCH')
                                            ...
                                            @endif
                                            <form action="{{ route('contrainte_salles.annuler', $contrainte->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette contrainte ?');">
                                                @csrf
                                                @method('DELETE')
