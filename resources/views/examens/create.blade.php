        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('examens.store') }}" method="POST">
                    ...
                    <div class="form-group mb-4">
                        <label for="id_personne" class="block text-gray-700 dark:text-gray-300">Enseignant</label>
                        <select name="id_personne" id="id_personne" class="form-control mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
