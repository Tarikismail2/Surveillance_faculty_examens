                    ...
                    <table id="exams-table" class="display min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                {{-- <th class="px-4 py-2 text-left text-sm font-medium text-gray-700">Affectation des surveillants</th> --}}
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($examens as $examen)
                                <tr>
                                    ...
                                    <td class="px-4 py-2">
                                        @if ($examen->sallePrincipale)
                                            {{ $examen->sallePrincipale->name }},
                                        @else
                                            N/A
                                        @endif
                                        ...
                                        @if ($examen->sallesSupplementaires && $examen->sallesSupplementaires->isNotEmpty())
                                            @foreach ($examen->sallesSupplementaires as $salle)
                                                @if ($salle->id !== $examen->sallePrincipale->id)
                                                ...
                                                <button type="submit"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <path fill-rule="evenodd"
                                                            d="M6 8a1 1 0 011-1h6a1 1 0 011 1v9a1 1 0 11-2 0v-1H8v1a1 1 0 11-2 0V8zm3-3a1 1 0 00-1-1V3a1 1 0 112 0v1a1 1 0 00-1 1z"
                                                            clip-rule="evenodd" />
                                                    </svg>
                                                </button>
                                            </form>
                                    ...
                                    {{-- <td class="px-4 py-2">
                                        ...
                                        @else
                                            <a href="{{ route('examens.showAssignInvigilatorsForm', $examen->id) }}"
                                                ...
                                                <span class="hidden md:inline">Affecter</span>
                                            </a>
                                        @endif
                                    </td> --}}
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center py-4 text-gray-500">Aucun examen trouvé.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
