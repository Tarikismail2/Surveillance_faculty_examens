    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-lg sm:rounded-lg p-6">
                ...
                <h3 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-6">{{ $examen->name }}</h3>

                <!-- Détails de l'examen -->
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg shadow-sm p-4 mb-6">
                    <h4 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">@lang('Informations de l\'examen')</h4>
                ...
                <h4 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">@lang('Affectations des surveillants')</h4>
