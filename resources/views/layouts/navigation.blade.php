        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:flex sm:items-center sm:ms-10">
                        ...
                        <x-nav-link href="/contrainte_salles" :active="request()->routeIs('contrainte_salles.index')">Contrainte Salle</x-nav-link>
            ...
            <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1 ml-4">
                    ...
                    <x-responsive-nav-link href="/sessions" :active="request()->routeIs('sessions')">Session</x-responsive-nav-link>
                    <x-responsive-nav-link href="/departments" :active="request()->routeIs('departments')">Departement</x-responsive-nav-link>
                    <x-responsive-nav-link href="/enseignants" :active="request()->routeIs('enseignants')">Enseignant</x-responsive-nav-link>
                    <x-responsive-nav-link href="/salles" :active="request()->routeIs('locales')">Locale</x-responsive-nav-link>
                    <x-responsive-nav-link href="/import" :active="request()->routeIs('upload.process')">importData</x-responsive-nav-link>
                    <x-responsive-nav-link href="/global" :active="request()->routeIs('examens.global')">GlobalPlan</x-responsive-nav-link>
                    <x-responsive-nav-link href="/select-enseignant" :active="request()->routeIs('selectEnseignant')">ProfPlan</x-responsive-nav-link>
                </div>
